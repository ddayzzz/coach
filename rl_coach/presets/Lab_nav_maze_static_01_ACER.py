...
from rl_coach.environments.lab_environment import level_scripts, LabEnvironmentParameters
...
# Environment #
###############
env_params = LabEnvironmentParameters(level='nav_maze_static_01', human_control=False, width=84, height=84)
